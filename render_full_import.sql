...
TRUNCATE TABLE public."MessageAttachment" CASCADE;
TRUNCATE TABLE public."Message" CASCADE;
TRUNCATE TABLE public."Conversation" CASCADE;
TRUNCATE TABLE public."ActivityLog" CASCADE;
TRUNCATE TABLE public."Notification" CASCADE;
TRUNCATE TABLE public."Invoice" CASCADE;
TRUNCATE TABLE public."Payment" CASCADE;
TRUNCATE TABLE public."Booking" CASCADE;
TRUNCATE TABLE public."Document" CASCADE;
TRUNCATE TABLE public."Review" CASCADE;
TRUNCATE TABLE public."MaintenanceRecord" CASCADE;
TRUNCATE TABLE public."Vehicle" CASCADE;
TRUNCATE TABLE public."UserPreferences" CASCADE;
TRUNCATE TABLE public."Session" CASCADE;
TRUNCATE TABLE public."User" CASCADE;
TRUNCATE TABLE public."CompanySettings" CASCADE;
TRUNCATE TABLE public."Integration" CASCADE;
TRUNCATE TABLE public."WebhookLog" CASCADE;
