  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEO
        ...
        description="Gem Car Rentals offers premium car rental services with a wide selection of vehicles from economy to luxury. Affordable rates, flexible booking, and exceptional service in Mulberry, Florida."
