...
export function exportToPDF(
  ...
  let htmlContent = `
    ...
    <body>
      <div class="header">
        <h1>${title}</h1>
        <div class="subtitle">Gem Car Rentals - Analytics Report</div>
  ...
  htmlContent += `
      <div class="footer">
        <p>This report was automatically generated by Gem Car Rentals CRM</p>
      </div>
    </body>
    </html>
  `;
    ...
    <body>
      ...
      <div class="section">
        ...
        <div class="info-grid">
          <div class="info-box">
            ...
            <p class="value">Gem Car Rentals</p>
      ...
      <div class="section terms">
        ...
        <ol>
          ...
          <li><strong>Emergency:</strong> In case of accident or breakdown, contact Gem Car Rentals immediately at (555) 123-4567.</li>
        </ol>
      </div>
      ...
      <div class="signature-section">
        <div class="signature-box">
          <div class="signature-line">
            ...
            <p style="font-size: 11px; margin-top: 5px;">Gem Car Rentals Representative</p>
          </div>
        </div>
        <div class="signature-box">
          <div class="signature-line">
      ...
      <div class="footer">
        ...
        <p>Gem Car Rentals | 123 Main Street, Los Angeles, CA 90001 | (555) 123-4567</p>
