...
const plans = [
  {
    ...
    features: ['Up to 10 vehicles', 'Basic analytics', 'Email support', 'Standard booking system'],
  },
  {
    id: 'professional',
    name: 'Professional',
        ...
        <div className="relative w-full max-w-4xl rounded-2xl bg-white shadow-xl">
          ...
          <div className="p-6">
                  ...
                  >
                    {plan.popular && !isCurrent && (
                      <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                        <span className="bg-primary text-primary-foreground flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium">
                      ...
                      className={cn(
                        ...
                        isCurrent
                          ...
                          : isDowngrade
                            ...
                            : plan.popular
                              ? 'bg-primary text-primary-foreground hover:bg-primary-dark shadow-primary-light shadow-lg'
            ...
            <div className="mt-6 text-center text-sm text-gray-500">
              ...
              <p className="mt-1">
                Need a custom plan?{' '}
                <a href="#" className="text-primary-ink hover:text-primary-dark">
                  Contact sales
                </a>
              </p>
            </div>
